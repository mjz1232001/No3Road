...
//			jsonObject = JSONObject.fromObject(buffer.toString());
	 ...
	 */
	public static long createMenu(Menu menu, String accessToken) throws JsonProcessingException {
		long result = 0;
		...
		if (null != jsonObject) {
			if (0 != (long)jsonObject.get("errcode")) {
				result = (long)jsonObject.get("errcode");
				log.error("创建菜单失败 errcode:{} errmsg:{}", (long)jsonObject.get("errcode"), (String)jsonObject.get("errmsg"));
			}
		}
